import React__default, { useState, useMemo, useEffect, useContext, createContext, startTransition, useCallback, useRef, cloneElement, forwardRef, useReducer, useId, Fragment as Fragment$1, createElement, memo, useSyncExternalStore } from 'react';
...
import { g as getPathPrefix, t as treeEntriesToTreeNodes, P as PKG_VERSION, K as KEYSTATIC_CLOUD_API_URL, a as KEYSTATIC_CLOUD_HEADERS, i as isGitHubConfig, r as redirectToCloudAuth, b as getEntriesInCollectionWithTreeKey, c as getSingletonPath, d as getTreeNodeAtPath, e as treeSha, f as treeToEntries, h as getBranchPrefix, n as nodeTypeMatcher, j as getSplitCloudProject, k as getRepoUrl, l as isLocalConfig, p as pluralize, m as getEntryDataFilepath, o as object, q as getDirectoriesForTreeKey, s as getTreeKey, u as blobSha, v as getCollectionPath, w as getCollectionFormat, x as getCollectionItemPath, y as getSlugGlobForCollection, z as getSlugFromState, A as updateValue, B as getKeysForArrayValue, C as setKeysForArrayValue, D as getInitialPropsValue, E as getAncestorComponentChildFieldDocumentFeatures, F as isBlock, G as allMarks, H as isListNode, I as isElementActive, J as getInitialPropsValueFromInitializer, L as aliasesToLabel, M as aliasesToCanonicalName, N as canonicalNameToLabel, O as labelToCanonicalName, Q as languagesWithAliases, R as transformProps, S as getValueAtPropPath, T as cloneDescendent, U as areArraysEqual, V as getSchemaAtPropPath, W as findChildPropPaths, X as getSelectedTableArea, Y as getRelativeRowPath, Z as cell, _ as clearFormatting, $ as EditorAfterButIgnoringingPointsWithNoContent, a0 as getInlineNodes, a1 as addMarksToChildren, a2 as setLinkForChildren, a3 as forceDisableMarkForChildren, a4 as addMarkToChildren, a5 as getPlaceholderTextForPropPath, a6 as Prism, a7 as _createDocumentEditor, a8 as getWholeDocumentFeaturesForChildField, a9 as serializeProps, aa as updateTreeWithChanges, ab as yjsToVal, ac as parsedValToYjs, ad as getNewArrayElementKey, ae as getYjsValFromParsedValue, af as getDataFileExtension, ag as getSingletonFormat, ah as isCloudConfig } from './index-3965aaa6.node.react-server.js';
import LRU from 'lru-cache';
import { isDefined, typedKeys, assert, assertNever } from 'emery';
...
import { N as NAVIGATION_DIVIDER_KEY, i as isValidURL } from './isValidURL-c29bb1bd.node.react-server.js';
...
import { toastQueue, Toaster } from '@keystar/ui/toast';
import 'decimal.js';
import '@sindresorhus/slugify';
import '@braintree/sanitize-url';
import { l as loadDataFile, p as parseProps, t as toFormattedFormDataError, v as validateArrayLength, P as PropValidationError } from './error-formatting-a30522e6.node.react-server.js';
