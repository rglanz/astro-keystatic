...
import { b as bytesToHex } from './hex-834c0b54.js';
...
import { ReactEditor, useSelected, useSlateStatic, useSlate, Slate, Editable, withReact } from 'slate-react';
...
import { z } from 'zod';
import { set, get, keys, delMany, createStore, entries, setMany, clear, del } from 'idb-keyval';
...
function CollabProvider(props) {
  ...
  return /*#__PURE__*/jsx(YjsContext.Provider, {
...
export { getKeysForArrayValue as $, getCollectionItemPath as A, getSlugGlobForCollection as B, parseRepoConfig as C, useTheme as D, getSyncAuth as E, redirectToCloudAuth as F, GitHubAppShellQuery as G, CloudAppShellQuery as H, serializeProps as I, BranchInfoContext as J, KEYSTATIC_CLOUD_API_URL as K, LOADING as L, useSetTreeSha as M, useCurrentUnscopedTree as N, updateTreeWithChanges as O, PageRoot as P, hydrateTreeCacheWithEntries as Q, RepoWithWriteAccessContext as R, scopeEntriesWithPathPrefix as S, ThemeProvider as T, fetchGitHubTreeData as U, treeSha as V, getSlugFromState as W, useConfig as X, useYjs as Y, yjsToVal as Z, parsedValToYjs as _, useTree as a, ArrayFieldValidationMessages as a$, getNewArrayElementKey as a0, setKeysForArrayValue as a1, updateValue as a2, getInitialPropsValueFromInitializer as a3, getDraft as a4, useYjsIfAvailable as a5, getYjsValFromParsedValue as a6, PageBody as a7, containerWidthForEntryLayout as a8, showDraftRestoredToast as a9, AppStateContext as aA, SidebarProvider as aB, GitHubAppShellProvider as aC, LocalAppShellProvider as aD, getSingletonFormat as aE, getSingletonPath as aF, isCloudConfig as aG, assertValidRepoConfig as aH, RouterProvider as aI, GitHubAppShellDataContext as aJ, CloudInfoProvider as aK, GitHubAppShellDataProvider as aL, basicFormFieldWithSimpleReaderParse as aM, FieldDataError as aN, assertRequired as aO, ImageFieldInput as aP, getSrcPrefix as aQ, fixPath as aR, useIsInDocumentEditor as aS, useObjectURL as aT, getUploadedFile as aU, useFieldContext as aV, SlugFieldContext as aW, PathContext as aX, validateText as aY, isValidURL as aZ, ArrayFieldListView as a_, createGetPreviewProps as aa, setDraft as ab, delDraft as ac, useEventCallback as ad, useRepositoryId as ae, useCreateBranchMutation as af, getBranchPrefix as ag, prettyErrorForCreateBranchMutation as ah, clientSideValidateProp as ai, getRepoUrl as aj, getDataFileExtension as ak, FormForEntry as al, isGitHubConfig as am, getInitialPropsValue as an, CreateBranchDialog as ao, useNavItems as ap, pluralize as aq, useViewer as ar, useCloudInfo as as, useSidebar as at, useContentPanelState as au, ContentPanelProvider as av, SidebarDialog as aw, SidebarPanel as ax, AppShellErrorContext as ay, ConfigContext as az, useBaseCommit as b, FormValueContentFromPreviewProps as b0, valueToUpdater as b1, useImageLibraryURL as b2, loadImageData as b3, emptyImageData as b4, ImageDimensionsInput as b5, parseImageData as b6, text as b7, document$1 as b8, config as b9, collection as ba, singleton as bb, BlockWrapper as bc, NotEditable as bd, ToolbarSeparator as be, getValueAtPropPath as bf, formatFormDataError as bg, treeEntriesToTreeNodes as bh, CloudImagePreview as bi, cloudImageToolbarIcon as bj, transformProps as bk, getUploadedFileObject as bl, useEntryLayoutSplitPaneContext as bm, useContentPanelSize as bn, Prism as bo, collectDirectoriesUsedInSchema as bp, CloudImagePreviewForNewEditor as bq, useIsRepoPrivate as c, useBranchInfo as d, getDirectoriesForTreeKey as e, getTreeKey as f, getEntryDataFilepath as g, useData as h, getTreeNodeAtPath as i, getBlobFromPersistedCache as j, blobSha as k, serializeRepoConfig as l, getPathPrefix as m, getAuth as n, object as o, parseProps as p, KEYSTATIC_CLOUD_HEADERS as q, l10nMessages as r, setBlobToPersistedCache as s, toFormattedFormDataError as t, useRouter as u, PageHeader as v, getCollectionPath as w, isLocalConfig as x, getEntriesInCollectionWithTreeKey as y, getCollectionFormat as z };
