...
var readSelection = (ctx, key, select, input, result) => {
  ...
  while ((node = iterate()) !== undefined) {
    ...
    if (!deferRef && dataFieldValue === undefined && (directives.optional || !!getFieldError(ctx) || store.schema && isFieldNullable(store.schema, typename, fieldName, ctx.store.logger))) {
